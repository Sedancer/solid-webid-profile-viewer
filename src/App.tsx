    ...
    return (
        <div className="min-h-screen bg-slate-50 dark:bg-slate-950">
            ...
            <main className="max-w-6xl mx-auto p-4 md:p-6">
                ...
                {!loading && profile && (
                    <div className="grid grid-cols-1 md:grid-cols-[340px,1fr] gap-6">
                        <Card className="p-6">
                        ...
                        <div className="space-y-6">
                            ...
                            {(profile.org || profile.title || profile.homepage || profile.bio) && (
                                <Card className="p-6 flex md:flex-row flex-col gap-4">
                            ...
                            <Card className="p-6">
                                <div className="text-lg font-semibold mb-3">Connections (foaf:knows)</div>
